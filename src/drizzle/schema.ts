...
export const ArmsApplicationTable: any = pgTable("arms_application", {
  id: uuid("id").primaryKey().defaultRandom(),
  name: varchar("name", { length: 100 }).notNull().unique(),
  fatherName: varchar("fatherName", { length: 100 }).notNull().unique(),
  CNICNumber: varchar("CNICNumber", { length: 18 }).notNull().unique(),
  criminalCase: boolean("criminalCase").notNull().default(false),
  applicationfor: varchar("applicationfor", { length: 255 }).notNull(),
  weaponType: varchar("weaponType", { length: 255 }).notNull(),
  cartridges: varchar("cartridges", { length: 255 }).notNull(),
  licenseNumber: varchar("licenseNumber", { length: 255 }).notNull().unique(),
  weaponNumber: varchar("weaponNumber", { length: 255 }).notNull().unique(),
